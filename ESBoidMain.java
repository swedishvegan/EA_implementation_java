...
public class ESBoidMain {
	
	protected final static int POP_SIZE = 50;
	protected final static int TRIALS = 10;
	protected final static int MAX_GENERATIONS = 50;
	
	public static void main(String[] args) {
		
		//the goal is to find the global minimum of ESBoid's function
		...
		for (int trial = 0; trial < TRIALS; trial++) {
			...
			for (int i = 0; i < POP_SIZE; i++) {individuals[i] = new ESBoidIndividual();}
			
			// Create population and selector.
			ESBoidPopulation population = new ESBoidPopulation(individuals);
